...
public class RegisterActivity extends AppCompatActivity {
    ...
    void clickRegister() {
        ...
        if (!name.isEmpty() && !email.isEmpty() &&  !password.isEmpty()){
            ...
            Toast.makeText(this, "Ingresar todos los caracteres", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        mAuthProvider.register(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(RegisterActivity.this, "No se pudo registrar con exito", Toast.LENGTH_SHORT).show();
...
/*
    void saveUser(String id, String name, String email) {
        ...
        //Toast.makeText(this, "El valor que seleccionaste fue " + selectedUser,Toast.LENGTH_SHORT).show();
        User user = new User();
        user.setId(email);
        user.setName(name);
