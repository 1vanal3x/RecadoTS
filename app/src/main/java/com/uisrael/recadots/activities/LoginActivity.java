    ...
    private void login(){
        ...
        if(!email.isEmpty() && !password.isEmpty()){
            if (password.length()>=6){
                ...
                Toast.makeText(this, "La contrasena debe tener mas de 6 caracteres", Toast.LENGTH_SHORT).show();
            }
        }
        else{
            Toast.makeText(this, "La contrasena y el Email son obligatorios", Toast.LENGTH_SHORT).show();
        }
