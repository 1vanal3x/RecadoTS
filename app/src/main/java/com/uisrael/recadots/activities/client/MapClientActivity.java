...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void requestDriver() {
        ...
        if (mOriginLatLng != null && mDestinationLatLng != null){
            ...
            Toast.makeText(this, "debe seleccionar el lugar de recogida", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void instanceAutocompleteOrigin(){
        ...
        mAutocomplete.setHint("Lugar de recojida");
    ...
    private void instanceAutocompleteDestination(){
        mAutocompleteDestination = (AutocompleteSupportFragment) getSupportFragmentManager().findFragmentById(R.id.placeaAutocompleteDestination);
    ...
    private void getActiveDrivers() {
        mGeofireProvider.getActiveDrivers(mCurrentLatLng, 10).addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                //los marcadores de los conductores que se encuentren en la aplicacion
                ...
                Marker marker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Conductor disponible").icon(BitmapDescriptorFactory.fromResource(R.drawable.iconcar)));
                marker.setTag(key);
